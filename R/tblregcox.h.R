...
tblRegCoxOptions <- if (requireNamespace("jmvcore", quietly=TRUE)) R6::R6Class(
    "tblRegCoxOptions",
...
tblRegCoxBase <- if (requireNamespace("jmvcore", quietly=TRUE)) R6::R6Class(
    "tblRegCoxBase",
    ...
    public = list(
        initialize = function(options, data=NULL, datasetId="", analysisId="", revision=0) {
            super$initialize(
                ...
                version = c(1,0,0),
                options = options,
                results = tblRegCoxResults$new(options=options),
                data = data,
                datasetId = datasetId,
