...
tblUniRegLogisticOptions <- if (requireNamespace("jmvcore", quietly=TRUE)) R6::R6Class(
    "tblUniRegLogisticOptions",
    ...
    public=list(
        initialize=function(options) {
            super$initialize(
                options=options,
                name="",
                title="Univariable Logistic Regression")
    ...
    public = list(
        initialize = function(options, data=NULL, datasetId="", analysisId="", revision=0) {
            super$initialize(
                ...
                version = c(1,0,0),
                options = options,
                results = tblUniRegLogisticResults$new(options=options),
                data = data,
                datasetId = datasetId,
...
tblUniRegLogistic <- function(
    ...
    options <- tblUniRegLogisticOptions$new(
        dep = dep,
        covs = covs,
        factors = factors,
